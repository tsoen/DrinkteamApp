 ...
 */
public class Connexion_Register extends Fragment
{
	/**
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState)
	{
		...
		return inflater.inflate(R.layout.connexion_register, container, false);
	}
	...
	public void onViewCreated(@NonNull final View view, Bundle savedInstanceState)
	{
		...
		LoginButton btn_facebook = view.findViewById(R.id.btn_new_account_facebook);
		
		// permissions d'accès pour l'application //
		btn_facebook.setReadPermissions(Arrays.asList( "public_profile", "email", "user_friends", "user_friends"));
		...
		// association du layout du bouton //
		SignInButton btn_google = view.findViewById(R.id.btn_new_account_google);
		...
		btn_google.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View view)
			{
				...
				getActivity().startActivityForResult(signInIntent, Config.GOOGLE_CREATE);
			}
		});
		...
		Button btn_email = view.findViewById(R.id.btn_new_account_email);
		// listener de click sur le bouton //
		btn_email.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				Utils.replaceFragments(Connexion_RegisterEmail.class, getActivity(), null, true);
			}
		});
